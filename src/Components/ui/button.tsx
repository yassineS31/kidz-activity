  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none  disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        greenway :
          "bg-emerald-700 text-primary-foreground shadow hover:bg-emerald-800 transition-all duration-300",
        destructive:
      ...
      size: {
        ...
        small:"w-20 h-6 rounded-xl px-3 text-xs",
        lg: "w-32 h-10 rounded-md px-8",
        rounded : "h-8 rounded-full px-8",
        icon: "h-9 w-9",
      },
    },
    defaultVariants: {
